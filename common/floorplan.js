	 ...
	 */
		...
		*/
		mxFloorplanWall.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanWall.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanWall.prototype.paintBackground = function (c, x, y, w, h) {
		...
		*/
		mxFloorplanWallCorner.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanWallCorner.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanWallCorner.prototype.paintBackground = function (c, x, y, w, h) {
		...
		*/
		mxFloorplanWallU.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanWallU.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanWallU.prototype.paintBackground = function (c, x, y, w, h) {
		...
		*/
		mxFloorplanRoom.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanRoom.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanRoom.prototype.paintBackground = function (c, x, y, w, h) {
		...
		*/
		mxFloorplanWindow.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanWindow.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanWindow.prototype.paintBackground = function (c, x, y, w, h) {
		...
		*/
		mxFloorplanDimension.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDimension.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDimension.prototype.paintBackground = function (c, x, y, w, h) {
			c.begin();
			c.moveTo(0, 20);
			c.lineTo(w, 20);
			c.moveTo(10, 15);
		...
		*/
		mxFloorplanDimensionBottom.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDimensionBottom.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDimensionBottom.prototype.paintBackground = function (c, x, y, w, h) {
			c.begin();
			c.moveTo(0, h - 20);
			c.lineTo(w, h - 20);
			c.moveTo(10, h - 15);
		...
		*/
		mxFloorplanStairs.prototype.paintVertexShape = function (c, x, y, w, h) {
			...
			mxFloorplanStairs.prototype.paintBackground.apply(this, [c, x, y, minW, h]);
		};

		mxFloorplanStairs.prototype.paintBackground = function (c, x, y, w, h) {
			c.rect(0, 0, w, h);
			c.fillAndStroke();
		...
		//};
		//
		//mxFloorplanStairsRest.prototype.paintBackground = function(c, x, y, w, h)
		//{
		//	c.rect(0, 0, w, h);
		//	c.fillAndStroke();
		//	
		...
		*/
		mxFloorplanStairsRest.prototype.paintVertexShape = function (c, x, y, w, h) {
			...
			var minW = Math.max(w, 50, h);
			var minH = Math.min(w, h);
			mxFloorplanStairsRest.prototype.paintBackground.apply(this, [c, x, y, minW, h]);
		};
		...
		*/
		mxFloorplanDoorLeft.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDoorLeft.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDoorLeft.prototype.paintBackground = function (c, x, y, w, h) {
			c.rect(0, 0, w, 5);
			c.fillAndStroke();
		...
		*/
		mxFloorplanDoorRight.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDoorRight.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDoorRight.prototype.paintBackground = function (c, x, y, w, h) {
			c.rect(0, 0, w, 5);
			c.fillAndStroke();
		...
		*/
		mxFloorplanDoorDouble.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDoorDouble.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDoorDouble.prototype.paintBackground = function (c, x, y, w, h) {
			var halfW = w * 0.5;
			c.rect(0, 0, w, 5);
			c.fillAndStroke();
		...
		*/
		mxFloorplanDoorUneven.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDoorUneven.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDoorUneven.prototype.paintBackground = function (c, x, y, w, h) {
		...
		*/
		mxFloorplanDoorOpposing.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDoorOpposing.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDoorOpposing.prototype.paintBackground = function (c, x, y, w, h) {
			var dx = w * Math.max(0, Math.min(w, parseFloat(mxUtils.getValue(this.style, 'dx', this.dx))));
		...
		*/
		mxFloorplanDoorRevolving.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDoorRevolving.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDoorRevolving.prototype.paintBackground = function (c, x, y, w, h) {
			var d = Math.min(w, h);
		...
		*/
		mxFloorplanDoorDoubleAction.prototype.paintVertexShape = function (c, x, y, w, h) {
			c.translate(x, y);
			mxFloorplanDoorDoubleAction.prototype.paintBackground.apply(this, arguments);
		};

		mxFloorplanDoorDoubleAction.prototype.paintBackground = function (c, x, y, w, h) {
