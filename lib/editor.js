...
var Editor = function () {
  ...
  _createClass(Editor, [{
    ...
    value: function initEditor(config) {
      ...
      _util2.default.initAutoSave({ graph: graph });
    ...
    key: 'initCustomPort',
    value: function initCustomPort(pic, isEnabled) {
    ...
    value: function setBackgroundImage(dataURL, browserWidth, browserHeight) {
      return _util2.default.setBackgroundImage(this.graph, dataURL, browserWidth, browserHeight);
    }
  }]);
