  ...
  render() {
    ...
    return [
      <div key="toolbar" className="toolbar">
        ...
        <div className="toolbar-btn background-image">
          <input
            type="file"
            accept="image/*"
            onChange={(event) => {
              // Subtract the toolbar(230px) and sidebar(40px) to the total height and width respectively
              // Also decrease the scrollbar size and margin (25px)
              const browserWidth = (window.innerWidth || document.body.clientWidth) - 230 - 25; 
              const browserHeight = (window.innerHeight || document.body.clientHeight) - 40 - 25;
              const reader = new FileReader();
              reader.onloadend = data => editor.setBackgroundImage(data.target.result, browserWidth, browserHeight);
