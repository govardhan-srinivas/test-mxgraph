...
export default class Editor {
  ...
  setBackgroundImage(dataURL, browserWidth, browserHeight) {
    return util.setBackgroundImage(this.graph, dataURL, browserWidth, browserHeight);
  }
}
